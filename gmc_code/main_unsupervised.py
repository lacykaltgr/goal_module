...
from training.callbacks import OnEndModelTrainingDummyGoal
...
def train_model(config):
    ...
    # Callbacks
    if exp_cfg["scenario"] == "dummy_goal":
        end_callback = OnEndModelTrainingDummyGoal()
    else:
    ...
    trainer = Trainer(
        ...
        callbacks=[checkpoint_callback, end_callback, TQDMProgressBar(refresh_rate=20)])
